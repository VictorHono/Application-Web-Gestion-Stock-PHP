...
<div class="home-content">
        <div class="overview-boxes">
            <div class="box">
                <form action="../index.php?action=inserer_commande" method="post">
                ...
                <select name="id_fournisseur" id="id_fournisseur">
                    <?php 
                        foreach($_SESSION['fournisseur'] as $Value){
                            ?>
                            <option value="<?= $Value['id_fournisseur'] ?>"><?= $Value['nom']." ".$Value['prenom'];
                            $_SESSION["id_fournisseur"] = $Value['id_fournisseur'];  ?></option>
                            <?php 
                        }
                    ?>
                </select>
